...
;(() => {
  ...
  el.id = 'vcr-globals'
  el.textContent = GLOBAL_CSS + `@keyframes spin{to{transform:rotate(360deg)}}`
  document.head.appendChild(el)
})()

const PAGE_TITLE = {
  overview:'Overview', keys:'API Keys', endpoints:'Endpoints', logs:'Request Logs',
  usage:'Usage & Quota', billing:'Billing', quickstart:'Quickstart',
  webhooks:'Webhooks', settings:'Settings',
}
